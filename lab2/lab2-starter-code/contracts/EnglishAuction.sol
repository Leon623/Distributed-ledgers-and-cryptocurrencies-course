...
contract EnglishAuction is Auction {
    ...
    function bid() public payable {
        ...
        require(msg.value>=initialPrice,"1");
        require(msg.value>=highestBid+minimumPriceIncrement,"2");
        ...
        //else{
            ...
            //finishAuction(Outcome.NOT_FINISHED,highestBidderAddress);
        //}
    ...
    function getHighestBidder() public override (Auction) returns (address){
